...
PREFIX_ROLES: list[tuple[str, str]] = [
    ...
    ('test/corpus/bbcsdl/tools/', 'BBCSDL corpus: IDE/tool program'),
    ('test/corpus/bbcsdl/sounds/', 'BBCSDL corpus: music/sound demo'),
    ('test/corpus/bbcsdl/physics/', 'BBCSDL corpus: physics simulation'),
    ('test/corpus/bbcsdl/graphics/', 'BBCSDL corpus: graphics demo'),
    ('test/corpus/bbcsdl/general/', 'BBCSDL corpus: general demo'),
    ('test/corpus/bbcsdl/calcs/', 'BBCSDL corpus: calculator/math demo'),
    ('test/corpus/bbcsdl/', 'BBCSDL corpus program'),
...
def render_inventory(files: list[FileInfo], generated_at: str) -> str:
    ...
    category_order = [
        ...
        'Corpus (bbcsdl/physics)',
        'Corpus (bbcsdl/sounds)',
        'Corpus (bbcsdl/calcs)',
