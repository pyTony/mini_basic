...
def _print_help_repl() -> None:
    _section('=== REPL commands ===', [
        ...
        'EDIT n      edit one program line (prefilled; empty Enter cancels)',
...
def _print_help_program() -> None:
    ...
    sections = [
        ...
        ('EDIT', [
            ...
            '  Empty Enter cancels (line unchanged). Enter alone keeps prefilled text.',
            '  To delete: bare line number at > (e.g. 15) or replace with empty stmt.',
            '  Cursor/word keys on Windows console.',
